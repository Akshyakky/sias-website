    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-gradient-to-b from-blue-900 via-blue-800 to-blue-700 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto px-4">
            Expert financial guidance for businesses of all sizes - from startups to established enterprises
          </p>
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              href="#contact"
              className="inline-block bg-white text-blue-900 px-8 py-3 rounded-md font-semibold hover:bg-blue-50 transition-colors shadow-lg mx-4"
            >
              Get Started
            </a>
          </div>
      ...
      <div id="services" className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-4 max-w-3xl mx-auto">
            At SIA Accounting Services, we provide expert financial guidance tailored to businesses of all sizes,
            from dynamic startups to well-established enterprises. Our commitment is to help you achieve financial clarity,
            compliance, and growth by offering comprehensive and professional accounting solutions.
          </p>
          <p className="text-gray-600 mt-4 max-w-3xl mx-auto">
            We offer a full range of accounting services designed to meet the unique needs of your business:
          </p>
        </div>
      ...
      <div id="contact" className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-4 max-w-3xl mx-auto">
            Experience the benefits of seamless financial management. Whether you're a growing startup or a large corporation,
            we're here to provide the financial expertise you need to thrive in today's competitive market.
          </p>
        </div>
        <ContactForm />
      </div>
