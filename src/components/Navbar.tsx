    ...
    <nav className="w-full">
      <div className="relative flex justify-end md:justify-start items-center">
        ...
        <button
          ...
          className="flex md:hidden text-gray-800 p-2 z-50"
        ...
        <div
          className={`absolute right-0 top-full mt-2 w-64 bg-white rounded-lg shadow-lg py-2 md:hidden z-50 transform transition-transform duration-200 ${isOpen ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'
            }`}
        >
          {links.map((link) => (
            <a
